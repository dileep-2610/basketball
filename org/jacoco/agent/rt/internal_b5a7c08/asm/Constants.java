...
/* 189 */       checkIsPreview(callerClass.getClassLoader().getResourceAsStream(stringConcat$0(internalName)));
/*     */     }
/*     */   }
/*     */   
/*     */   static boolean isWhitelisted(String internalName) {
/* 194 */     if (!internalName.startsWith("org/jacoco/agent/rt/internal_b5a7c08/asm/")) {
/* 195 */       return false;
/*     */     }
/* 197 */     String member = "(Annotation|Class|Field|Method|Module|RecordComponent|Signature)";
/* 198 */     return (internalName.contains("Test$") || 
/* 199 */       Pattern.matches(stringConcat$1(member), internalName) || 
/*     */       
/* 201 */       Pattern.matches(stringConcat$2(member), internalName));
/*     */   }
/*     */   
...
/* 217 */       throw new IllegalStateException("ASM10_EXPERIMENTAL can only be used by classes compiled with --enable-preview"); 
/*     */   }
/*     */ }


/* Location:              /Users/mac/Downloads/jacocoagent.jar!/org/jacoco/agent/rt/internal_b5a7c08/asm/Constants.class
